...
// Canonical shift list/order for the auditor's shift heatmap — fixed domain
// list, independent of which leader currently owns which shift.
export const SHIFT_ORDER = [
  { code: 'FHD', label: 'Front Half, Days' },
  { code: 'FHS', label: 'Front Half, Mids' },
  { code: 'FHN', label: 'Front Half, Nights' },
  { code: 'BHD', label: 'Back Half, Days' },
  { code: 'BHS', label: 'Back Half, Mids' },
  { code: 'BHN', label: 'Back Half, Nights' },
]
